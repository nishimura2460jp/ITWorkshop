...
<h1>シフト表 作成アプリ</h1>
 ...
 <main>
   <section id="main-menu">
            <h2>&#9661; メインメニュー &#9661;</h2>
            <h3>管理者&#128221;</h3>
            <button onclick="location.href='BasicSettingServlet'" target="_blank" rel="noopener noreferrer">基本設定</button>
            <button onclick="location.href='ShiftCreateServlet'" target="_blank" rel="noopener noreferrer">シフト作成の準備・作成</button>
